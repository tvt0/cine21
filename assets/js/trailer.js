(function ($) {
    (function handleTrailer() {
        ...
        var $selector = {
            ...
            overlay: $("#blackout"),
            modal: $("#trailerModal"),
            showButoon: $("#showTrailer"),
            hideButoon: $("#hideTrailer"),
        };
        ...
        //보이기, 숨기기 버튼 활성화
        $selector.showButoon.on("click", showPlayer);
        $selector.hideButoon.on("click", hidePlayer);
        ...
        function resizePlayer(){
            ...
            frame.height = frame.width / 1.6;  //16:10비율
        ...
        function showPlayer(){
            if(!player.obj){
                setPlayer($selector.showButoon.data("youtube"));
            }
